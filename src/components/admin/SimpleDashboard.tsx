...
const SimpleDashboard = () => {
  ...
  const quickActions = [
    ...
    },
    {
      ...
      description: 'Edit hero images, testimonials, and more',
      icon: Home,
      path: '/admin/homepage',
      color: 'bg-orange-500'
    },
    {
      ...
      description: 'Test real-time video upload progress',
      icon: TrendingUp,
      path: '/admin/progress-demo',
      color: 'bg-teal-500'
    },
    {
      title: 'View Feedback',
  ...
  console.log('SimpleDashboard rendering, loading:', loading);
